   ...
   (structure Streamable : STREAMABLE
    structure Arg :
       sig
          ...
          val fn_ : string * exp -> exp
          val print : exp -> exp
          val app_exp : exp -> exp
          val app : exp * exp -> exp
          val atm_app : exp -> exp
          val push : names * exp -> exp
          val fork : exps -> exp
          val refine : string -> exp
          val quote : oexp -> exp
          val exp_atm : exp -> exp
          val prove : oexp * exp -> exp
          val let_ : string * exp * exp -> exp
          val proj2 : unit -> exp
          val proj1 : unit -> exp
...
(2,1,(fn Value.string(arg0)::rest => Value.exp(Arg.var arg0)::rest|_=>raise (Fail "bad parser"))),
(2,1,(fn _::rest => Value.exp(Arg.goal {})::rest|_=>raise (Fail "bad parser"))),
...
(2,7,(fn _::Value.exp(arg0)::_::Value.exp(arg1)::_::Value.string(arg2)::_::rest => Value.exp(Arg.let_ {3=arg0,2=arg1,1=arg2})::rest|_=>raise (Fail "bad parser"))),
...
(2,2,(fn Value.string(arg0)::_::rest => Value.exp(Arg.refine arg0)::rest|_=>raise (Fail "bad parser"))),
(2,3,(fn _::Value.exps(arg0)::_::rest => Value.exp(Arg.fork arg0)::rest|_=>raise (Fail "bad parser"))),
(2,5,(fn _::Value.exp(arg0)::_::Value.names(arg1)::_::rest => Value.exp(Arg.push {2=arg0,1=arg1})::rest|_=>raise (Fail "bad parser"))),
...
(0,4,(fn Value.exp(arg0)::_::Value.string(arg1)::_::rest => Value.exp(Arg.fn_ {2=arg0,1=arg1})::rest|_=>raise (Fail "bad parser"))),
