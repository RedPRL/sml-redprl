...
"line"             => (Tokens.LINE (posTuple (size yytext))); 
...
"coeq"             => (Tokens.COEQUALIZER (posTuple (size yytext)));
"cecod"            => (Tokens.CECOD (posTuple (size yytext)));
"cedom"            => (Tokens.CEDOM (posTuple (size yytext)));
"coeq-rec"         => (Tokens.COEQUALIZER_REC (posTuple (size yytext)));
...
"id"               => (Tokens.TAC_ID (posTuple (size yytext)));
"fail"             => (Tokens.TAC_FAIL (posTuple (size yytext)));
"symmetry"         => (Tokens.TAC_SYMMETRY (posTuple (size yytext)));
"auto-step"        => (Tokens.TAC_AUTO_STEP (posTuple (size yytext)));
