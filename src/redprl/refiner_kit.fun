...
struct
  ...
  structure Tactical = NominalLcfTactical (NominalLcfStructure)

  open NominalLcfStructure Tactical
  infix orelse_ then_
  ...
  fun makeDimSubst (I, H) (r, u, m) = makeGoal @@ (I, H) >> CJ.DIM_SUBST (r, u, m)
