...
syn keyword redprlExpr zero succ nat-rec int negsucc int-rec void S1 base loop
syn keyword redprlExpr S1-rec lam record tuple path line pushout left right glue
syn keyword redprlExpr pushout-rec coeq cecod cedom coeq-rec mem ni box cap V VV WU
syn keyword redprlExpr Vin Vproj U abs hcom com coe lmax omega
