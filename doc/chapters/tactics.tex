...
$\LCFElab{\Upsilon}{\Gamma}{t}{\tau}{\rho}{T}$ is defined by recursion on
$t:\SortTac$ such that $\Member{T}{\LCFAtomicTactic}$, presupposing that
$\Member{\rho(x)}{\LCFAtomicTactic}$ for each $\Member{x:\SortTac}{\Gamma}$.
