...
%%   \infer{
%%     \LCFElabSt{\Upsilon}{\Gamma}{
%%       \TacSeq{t}{\vec{a}}{\TacEach{t_1,\dots,t_n}}
%%     }{
%%       \mathtt{THENL}(T,[T_1,\dots,T_n])(\mathcal{J})
%%     }{S}
%%   }{
%%     \begin{array}{l}
%%       \LCFElabSt{\Upsilon}{\Gamma}{t}{T}{\vec{a}::S}\\
%%       \HypJ{
%%         \LCFElabSt{\Upsilon,\vec{a}:\SortHyp}{\Gamma}{t_i}{T_i}{S}
%%       }{
%%         \Leq{i}{n}
%%       }
%%     \end{array}
...
%%     }{
%%       \mathtt{THENF}(T_1, i, T_2)(\mathcal{J})
%%     }{S}
%%   }{
%%     \begin{array}{l}
%%       \LCFElabSt{\Upsilon}{\Gamma}{t_1}{T_1}{\vec{a}::S}\\
%%       \LCFElabSt{\Upsilon,\vec{a}:\SortHyp}{\Gamma}{t_2}{T_2}{S}
%%     \end{array}
%%   }
%% \]
%%
