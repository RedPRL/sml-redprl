...
\[
  \infer{
    ...
    \HypJ{
      \LCFElabSt{\Upsilon,\vec{u}:\SortHyp}{\Gamma}{t_i}{J_i}{Q_{J_i}}{\beta}{\mu_{J_i}}
    }{
      \Member{J_i}{\Dom{P}}
    } &
    \Match{\bigsqcup_{J\in\Dom{P}}\mu_J}{\mu}
...
%   }{
%     \begin{array}{l}
%       \LCFElabSt{\Upsilon}{\Gamma}{t_1}{J}{
%         \MLPair{[J_0,\dots,J_n]}{E}
%       }{\vec{u}\oplus\alpha}{\mu}\\
%       \HypJ{
%         \LCFElabSt{\Upsilon,\vec{u}:\SortHyp}{\Gamma}{t_i}{J_i}{
%           \MLPair{\vec{K}_i}{F_i}
%         }{\beta}{\mu_i}
%       }{
%         \Leq{i}{n}
...
%       \LCFElabSt{\Upsilon,\vec{u}:\SortHyp}{\Gamma}{t_2}{J_i}{
%         \MLPair{\vec{K}}{F}
%       }{\beta}{\mu_2}
%     \end{array} &
%     \begin{array}{l}
...
%         \vec{J}
%       }{
%         \vec{J}_<\oplus[\vec{J}_i]\oplus\vec{J}_>
%       }\\
%       \Match{
%         \vec{x}
%       }{
