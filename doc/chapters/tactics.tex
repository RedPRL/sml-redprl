...
interpret all of \textbf{Nominal LCF} into $\mathcal{M}$, by defining an algorithmic
...
When it leads to no ambiguity, we will write $\LCFElab{\Upsilon}{\Gamma}{t}{T}$
instead of the more verbose $\LCFElabVerbose{\Upsilon}{\Gamma}{t}{T}$; we will
