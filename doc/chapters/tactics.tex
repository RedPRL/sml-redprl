...
\[
  \infer{
    \LCFElabSt{\Upsilon}{\Gamma}{\TacSmash{t_1}{t_2}}{
      \mathtt{THEN}(T_1,T_2)
    }{\alpha}{\mu}
  }{
    \begin{array}{l}
      \LCFElabSt{\Upsilon}{\Gamma}{t_1}{T_1}{\alpha}{\mu_1}\\
      \LCFElabSt{\Upsilon}{\Gamma}{t_2}{T_2}{
        \StreamChop{\alpha}{\mu_1}
      }{\mu_2}
    \end{array} &
    \BackDefine{
      \mu(J)
    }{
      \mu_1(J) + \bigsqcup_{i<\MLLength{T_1(J)}}\mu_2(\Dom{T_1(J)}_i)
    }
  }
\]
...
\[
  \infer{
    ...
    \begin{array}{l}
      \LCFElabSt{\Upsilon}{\Gamma}{t_1}{T_1}{\vec{u}\oplus\alpha}{\mu_1}\\
      \LCFElabSt{\Upsilon,\vec{u}:\SortHyp}{\Gamma}{t_2}{T_2}{\StreamChop{\vec{u}\oplus\alpha}{\mu_1}}{\mu_2}
    \end{array} &
    \BackDefine{
      \mu(J)
    }{
...
\[
  \infer{
    \LCFElabSt{\Upsilon}{\Gamma}{
      ...
      \mathtt{THENL}(T, \left[T_i\mid i<n\right])
    }{\alpha}{\mu'}
  }{
    \begin{array}{l}
      \LCFElabSt{\Upsilon}{\Gamma}{t}{T}{\vec{u}\oplus\alpha}{\mu}\\
      \HypJ{
        \LCFElabSt{\Upsilon,\vec{u}:\SortHyp}{\Gamma}{t_i}{T_i}{\StreamChop{\vec{u}\oplus\alpha}{\mu}}{\mu_i}
      }{
        \LT{i}{n}
      }
    \end{array} &
    \BackDefine{
      ...
      \mu(J) + \bigsqcup_{i<\MLLength{T(J)}}\mu_i(\Dom{T(J)}_i)
    }
  }
\]
