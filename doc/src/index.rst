...
* Kuen-Bang Hou (Favonia). `Computational Higher-Dimensional Type Theory & RedPRL`_. Big Proof 2017.
...
.. _Computational Higher-Dimensional Type Theory & RedPRL: https://www.math.ias.edu/~favonia/files/chtt-bigproof2017-slides.pdf
