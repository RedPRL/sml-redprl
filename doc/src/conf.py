# -*- coding: utf-8 -*-
#
# RedPRL documentation build configuration file.
#
...
project = u'RedPRL'
copyright = u'2015–2018, The RedPRL Development Team'
author = u'The RedPRL Development Team'
...
def setup(app):
    app.add_stylesheet('http://cs.cmu.edu/~jmsterli/fonts/PragmataPro.css')
