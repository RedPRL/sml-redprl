...
\begin{mathparpagebreakable}
  ...
  \inferrule{
    ...
    \perfectbrackets{
      ...
      \Meta{y}\hookrightarrow{x.\Clo{B}{[\EE,a\hookrightarrow\Clo{\Coe{r}{x}{y.\Meta{x}[y]}{\Snd{M}}}{[\EE,\Meta{x}\hookrightarrow{x.\Clo{A}{\EE}}]}]}}
    }
  }{
    \Step{\mu}{
      \Cfg{
...
\begin{mathparpagebreakable}
  ...
  \inferrule{
    ...
    \EE''\triangleq\perfectbrackets{
      ...
      \Meta{x}\hookrightarrow{}x.\Clo{A}{\EE},
      \overline{
        \Meta{y}_\epsilon\hookrightarrow{}.\Clo{P_\epsilon}{\EE}%
      }
    }
  }{
    \Step{\mu}{
