...
So, we have $M[\Env{\EE}{\FF}]$ everywhere. Here is the definition disguised as rules.

\begin{mathparpagebreakable}
  \inferrule{
    \EE^+(a) = \Clo{M}{\EE'}{\LL}
  }{
    \DoubleForce{a}{\EE}{\FF} = \DoubleForce{M}{\EE'}{\Cons{\FF}{\LL}}
  }
  \and
  \inferrule{
    a \notin \EE
  ...
  \inferrule{
    ...
    \Force{a}{\Cons{\FF}{\LL}} = \Force{M}{\LL}
  }
  \and
  \inferrule{
    a \notin \FF
  }{
    \Force{a}{\Cons{\FF}{\LL}} = \Force{a}{\LL}
  }
  \\
  \inferrule{
  }{
