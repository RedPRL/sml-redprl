...
\newcommand\Record[1]{\mathsf{record} (#1)}
\newcommand\Tuple[1]{\mathsf{tuple} (#1)}
\newcommand\Label[1]{\mathtt{#1}}
\newcommand\Proj[2]{\mathsf{proj}_{\Label{#1}} (#2)}
...
\subsection{Non-dependent record types}

\begin{mathparpagebreakable}
  \inferrule{
  }{
    \Step{\mu}{
      \Cfg{\Proj{l}{M}}{\EE}{\FF}{\pi}
    }{
      \Cfg{M}{\EE}{\FF}{\Cons{\Frame{\Proj{l}{\Box}}{[]}{[]}{[]}}{\pi}}
    }
  }
  \and
  \inferrule{
    ...
    \Step{\mu}{
      \Cfg{\Tuple{\overline{[\Label{l_i}\hookrightarrow M_i]}}}{\EE}{\FF}{\Cons{\Frame{\Proj{l_i}{\Box}}{\Dummy}{\Dummy}{[]}}{\pi}}
    }{
      \Cfg{M_i}{\EE}{\FF}{\pi}
    }
  }
  ...
  \inferrule{
    O_j\triangleq{
      \HCom{r}{r'}{a_j}{\Proj{l_j}{M}}{\overline{\xi_i\hookrightarrow{}y.\Proj{l_j}{N_i}}}
    }
    \\
    \EE''\triangleq{
      \perfectbrackets{
        \EE',
        \overline{a_j\hookrightarrow{}\Clo{A_j}{\EE}{\FF}}
      }
    }
  }{
    \Step{\mu}{
      \Cfg{\Record{\overline{\Label{l_j}\hookrightarrow{A_j}}}}{\EE}{\FF}{
        \Cons{
          \Frame{
            \HCom{r}{r'}{\Box}{M}{\overline{\xi_i\hookrightarrow{}y.N_i}}
          }{\EE'}{\FF'}{[]}
      ...
      \Cfg{
        \Tuple{\overline{\Label{l_j}\hookrightarrow{O_j}}}
      }{
        \EE''
      }{
        \FF'
  ...
  \inferrule{
    ...
    \perfectbrackets{
      \EE',
      \overline{\Meta{x}_j\hookrightarrow{x.\Clo{A_j}{\EE}{\FF}}}
    }
  }{
    \Step{\mu}{
      \Cfg{
        \Record{\overline{\Label{l_j}\hookrightarrow{A_j}}}
      }{
        \EE
      }{
        \FF
      ...
      \Cfg{
        \Tuple{
          \overline{
            \Coe{r}{r'}{x.\Meta{x}_j[x]}{\Proj{l_j}{M}}
          }
        }
      }{
        \EE''
