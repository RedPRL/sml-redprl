...
\begin{mathparpagebreakable}
  \inferrule{
    ...
    \Step{\mu}{
      \Cfg{\WIf{x.A}{M}{T}{F}}{\mathcal{E}}{\pi}
    }{
      \Cfg{M}{\mathcal{E}}{
        \Cons{\Frame{\WIf{x.A}{\Box}{T}{F}}{\mathcal{E}}{[]}}{\pi}
      }
    }
  }
  \and
  ...
  \inferrule{
    \DimApart{\mathcal{E}}{r}{r'}
    \\
    \DimApart{\mathcal{E}}{r_i}{r'_i}\ (\forall{}i)
    \\
    H\triangleq{
      \FCom{r}{z}{M}{
        \overline{
    ...
    \Cfg{
      ...
      \Cons{
        \Frame{\WIf{x.A}{\Box}{T}{F}}{\mathcal{E}'}{[]}
      }{\pi}
    }
    \\\\
    \mathrel{\succ_\mu}
...
TODO, add hcom, coe, rec-fcom, etc.
\begin{mathparpagebreakable}
  \inferrule{
  ...
  \inferrule{
    ...
    \Cfg{
      ...
      \Cons{
        \Frame{\CircRec{x.A}{\Box}{P}{x.L}}{\mathcal{E}'}{[]}
      }{\pi}
    }
    \\\\
    \mathrel{\succ_\mu}
