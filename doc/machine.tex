...
\[
  \begin{array}{rrlr}
    M,A &::= &a\mid \Meta{x}[\vec{r};\vec{M}] \mid \Coe{r}{r'}{x.A}{M}\mid\ldots&\text{(terms)}\\
    K &::= &\Coe{r}{r'}{\Box}{M}\mid\App{\Box}{N}\mid\Fst{\Box}\mid\ldots&\text{(continuations)}\\
...
\begin{mathparpagebreakable}
  ...
  \inferrule{
    \mathcal{E}\equiv(\Meta{\gamma},\gamma,\psi)
    \\
    \Meta{\gamma} (\Meta{x})\equiv{\vec{x};\vec{a}.N}
    \\
    \gamma'\triangleq\perfectparens{
      \gamma,\overline{a\hookrightarrow\Clo{M}{\mathcal{E}}}
    }
    \\
    \psi'\triangleq\perfectparens{
      \psi,\overline{x\hookrightarrow{r\psi}}
    }
  }{
    \Step{\Stable}{
